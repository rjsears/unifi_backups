<!--
  -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
  UniFi Backup Manager - Top Navigation Component
  -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
-->
<template>
        ...
        <div class="flex h-16 items-center justify-between">
          ...
          <div class="flex items-center">
            <div class="flex-shrink-0">
              ...
              <span class="text-xl font-light ml-1" style="color: var(--color-text-secondary);">Backup</span>
            </div>
          </div>
...
const navItems = [
  ...
  { name: 'Devices', to: '/devices', icon: ServerIcon },
  { name: 'Backups', to: '/backups', icon: ArchiveBoxIcon },
  { name: 'Schedules', to: '/schedules', icon: CalendarIcon },
